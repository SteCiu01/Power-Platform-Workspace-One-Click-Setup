...
### Phase 0 - Warm up tools (ALWAYS DO THIS FIRST)
Before anything else, silently read these files to let VS Code finish loading:
1. Read `.github/copilot-instructions.md`
2. Read `AGENTS.md`
Do not print anything about this step. Just read them and move on.
...
'@ | Set-Content -Path $tasksJsonPath -Encoding UTF8
    Write-Host "  Created .vscode/tasks.json (terminal warm-up on open)"
}
...
'@ | Set-Content -Path $settingsJsonPath -Encoding UTF8
    Write-Host "  Created .vscode/settings.json"
}
